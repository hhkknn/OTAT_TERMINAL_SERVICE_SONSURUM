    ...
    public class AddOrUpdateKonteynerYapmaListesi
    {
        ...
        public Response addOrUpdateKonteynerYapmaListesi(string dbName, KonteynerYapma konteynerYapma, List<KonteynerIcindenSilinenler> konteynerIcindenSilinenlers, string cekmeListesiKalemleriniGrupla)
        {
            ...
            try
            {
                ...
                {
                    oRS.DoQuery("Select \"DocEntry\",\"U_MuhatapKodu\",\"U_MuhatapAdi\" from \"@AIF_WMS_KNTYNR\" as T0 WITH (NOLOCK) where T0.\"U_KonteynerNo\" = N'" + konteynerYapma.KonteynerNumarasi + "'");
                }
                ...
                if (oRS.RecordCount == 0) //Daha önce bu konteyner kayıt girilmiş mi?
                {
                    ...
                    foreach (var item in konteynerYapma.konteynerYapmaDetays)
                    {
                        ...
                        if (item.UrunKonteynereDahaOnceEklendi != "Y")
                        {
                            if (cekmeNoListesi.Count() > 0)
                            {
                                ...
                                {
                                    string qq = "Select T1.\"LineId\",T0.\"DocEntry\",(T1.\"U_PlanSipMik\" - T1.\"U_ToplananMik\") as 'KalanMiktar' from \"@AIF_WMS_SIPKAR\" AS T0 WITH (NOLOCK) INNER JOIN \"@AIF_WMS_SIPKAR1\" AS T1 WITH (NOLOCK) ON T0.\"DocEntry\" = T1.\"DocEntry\" where T0.\"DocEntry\" = '" + item.CekmeListesiNo + "' and CONCAT(T1.\"U_SiparisNumarasi\", '-', T1.\"U_SipSatirNo\")  = '" + cekmeNoListesi[i].ToString() + "'";
                            ...
                            {
                                oRS_LineId.DoQuery("Select T1.\"LineId\",T0.\"DocEntry\" from \"@AIF_WMS_SIPKAR\" AS T0 WITH (NOLOCK) INNER JOIN \"@AIF_WMS_SIPKAR1\" AS T1 WITH (NOLOCK) ON T0.\"DocEntry\" = T1.\"DocEntry\" where T0.\"DocEntry\" = '" + item.CekmeListesiNo + "' and T1.\"U_SipSatirNo\" = '" + item.siparisSatirNo + "' and T1.\"U_SiparisNumarasi\" = '" + item.siparisNo + "'");
                    ...
                    oRS.DoQuery("Select TOP 1 \"DocEntry\" from \"@AIF_WMS_KNTYNR\" WITH (NOLOCK) order by \"DocEntry\" desc ");

                    int maxdocentry = Convert.ToInt32(oRS.Fields.Item(0).Value);

                    oGeneralData.SetProperty("DocNum", maxdocentry);

                    #endregion Konteyner Yapma
                    ...
                    if (resp != null)
                    {
                        ...
                        foreach (var item in paletnolistesi)
                        {
                            ...
                            oRS.DoQuery("Select \"DocEntry\",\"U_PaletNo\" from \"@AIF_WMS_PALET\" as T0 WITH (NOLOCK) where T0.\"U_PaletNo\" = '" + item + "'");
                        ...
                        #endregion Palet Tablosunu Güncelleme
                        ...
                        try
                        {
                            if (konteynerYapma.konteynerYapmaDetays.Count > 0)
                            {
                                ...
                                foreach (var itemy in konteynerYapma.konteynerYapmaDetays.Where(x => x.siparisNo != -1 && x.siparisSatirNo != -1 && x.UrunKonteynereDahaOnceEklendi == ""))
                                {
                                    ...
                                    //{
                                    oRS.DoQuery("Select MAX(\"DocEntry\") from \"@AIF_WMS_TOPLANAN\" as T0 WITH (NOLOCK) ");
                                ...
                                {
                                    SAPbobsCOM.Recordset orecord = (SAPbobsCOM.Recordset)oCompany.GetBusinessObject(BoObjectTypes.BoRecordset);
                                    orecord.DoQuery("Select * from \"@AIF_WMS_TOPLANAN\" as T0 WITH (NOLOCK) where T0.\"U_SiparisNumarasi\" = '" + itemy.siparisNo + "' and T0.\"U_SiparisSatirNo\" = '" + itemy.siparisSatirNo + "' and \"U_PaletNo\" = '" + itemy.PaletNo + "' " + condition + "(\"U_KntynrNo\",'') ='' ");
                        ...
                        #endregion Toplanan Siparişler tablosuna ekleme
                ...
                else
                {
                    ...
                    #endregion Sipariş karşılama ekranı değişkenleri
                        ...
                        try
                        {
                            if (konteynerYapma.konteynerYapmaDetays.Count > 0)
                            {
                                ...
                                if (cekmeListesiKalemleriniGrupla != "Y")
                                {
                                    ...
                                    {
                                        SAPbobsCOM.Recordset orecord = (SAPbobsCOM.Recordset)oCompany.GetBusinessObject(BoObjectTypes.BoRecordset);
                                        orecord.DoQuery("Select * from \"@AIF_WMS_TOPLANAN\" as T0 WITH (NOLOCK) where T0.\"U_SiparisNumarasi\" = '" + itemy.siparisNo + "' and T0.\"U_SiparisSatirNo\" = '" + itemy.siparisSatirNo + "' and \"U_PaletNo\" = '" + itemy.PaletNo + "' and " + condition + "(\"U_KntynrNo\",'') ='' ");
                                ...
                                else
                                {
                                    ...
                                    {
                                        SAPbobsCOM.Recordset orecord = (SAPbobsCOM.Recordset)oCompany.GetBusinessObject(BoObjectTypes.BoRecordset);
                                        orecord.DoQuery("Select * from \"@AIF_WMS_TOPLANAN\" as T0 WITH (NOLOCK) where T0.\"U_Kaynak\" = '" + itemy.satirKaynagi + "' and \"U_PaletNo\" = '" + itemy.PaletNo + "' and " + condition + "(\"U_KntynrNo\",'') ='' ");
                                    ...
                                    foreach (var itemxy in konteynerIcindenSilinenlers.Where(x => x.paletNo == ""))
                                    {
                                        ...
                                        string sql = "SELECT \"DocEntry\",\"U_Miktar\" FROM \"@AIF_WMS_TOPLANAN\" WITH (NOLOCK) where \"U_SiparisNumarasi\" = '" + itemxy.siparisNo + "' and \"U_SiparisSatirNo\" = '" + itemxy.siparisSatirNo + "' and \"U_BelgeNo\" = '" + itemxy.cekmeNo + "' and " + condition + "(\"U_PaletNo\",'')='' and \"U_Miktar\" >= " + itemxy.miktar + " ";
        ...
        public Response addOrUpdateKonteynerYapmaListesi_Final(string dbName, KonteynerYapma konteynerYapma, List<KonteynerIcindenSilinenler> konteynerIcindenSilinenlers, string cekmeListesiKalemleriniGrupla)
        {
            ...
            try
            {
                ...
                #endregion SAP CompanyService ve GeneralData tanımlamaları
                ...
                {
                    string sorgu = "Select \"DocEntry\",\"U_MuhatapKodu\",\"U_MuhatapAdi\" from \"@AIF_WMS_KNTYNR\" as T0 WITH (NOLOCK) where T0.\"U_KonteynerNo\" = N'" + konteynerYapma.KonteynerNumarasi + "'";

                    oRS.DoQuery("Select \"DocEntry\",\"U_MuhatapKodu\",\"U_MuhatapAdi\" from \"@AIF_WMS_KNTYNR\" as T0 WITH (NOLOCK) where T0.\"U_KonteynerNo\" = N'" + konteynerYapma.KonteynerNumarasi + "'");
                }

                #endregion Konteyner daha önce oluşturulmuş mu kontrolü
                ...
                if (oRS.RecordCount == 0) //Konteyner daha önce ekli değil ise buraya girer.
                {
                    ...
                    #endregion Konteyner verilerini doldurma
                    ...
                    if (cekmeListesiKalemleriniGrupla == "Y") //Genel parametreler ekranındaki çekme listesini grupla işaretli ise bu işlem yapılır.
                    {
                        foreach (var item in konteynerYapma.konteynerYapmaDetays.Where(x => x.PaletNo != ""))
                        {
                            ...
                            #endregion Konteyner listesinin içerisinde bulunan satır kaynakları alınır.
                            ...
                            {
                                SAPbobsCOM.Recordset orecord = (SAPbobsCOM.Recordset)oCompany.GetBusinessObject(BoObjectTypes.BoRecordset);
                                orecord.DoQuery("Select * from \"@AIF_WMS_TOPLANAN\" as T0 WITH (NOLOCK) where T0.\"U_BelgeNo\" = '" + item.CekmeListesiNo + "' and T0.\"U_SiparisNumarasi\" = '" + satirKaynagiListesi[i].ToString().Split('-')[0].Trim() + "' and T0.\"U_SiparisSatirNo\" = '" + satirKaynagiListesi[i].ToString().Split('-')[1].Trim() + "' and \"U_PaletNo\" = '" + item.PaletNo + "' and " + condition + "(\"U_KntynrNo\",'') ='' ");
                            ...
                            #endregion Yukarıda alınan satır kaynakları kendi aralarında - ile split edilip toplanan tablosunda konteyner update edilir.
                        }
                                ...
                                if (oRS_LineId.RecordCount > 0)
                                {
                                    ...
                                    for (int z = 0; z <= oChildrenSatir_SIPKAR.Count - 1; z++)
                                    {
                                        ...
                                        if (Convert.ToInt32(aa) == Convert.ToInt32(lineid))
                                        {
                                            ...
                                            #endregion Sipariş Karşılama Ekranındaki eşleşen kayıda göre toplanana kayıt atılır.
                                        }
                                    }
                        ...
                        #endregion Toplanan ve sipariş karşılama ekranlarına datalar güncellenir.
                    }
                    else
                    {
                        ...
                        {
                            SAPbobsCOM.Recordset orecord = (SAPbobsCOM.Recordset)oCompany.GetBusinessObject(BoObjectTypes.BoRecordset);
                            orecord.DoQuery("Select * from \"@AIF_WMS_TOPLANAN\" as T0 WITH (NOLOCK) where T0.\"U_BelgeNo\" = '" + item.CekmeListesiNo + "' and T0.\"U_SiparisNumarasi\" = '" + item.siparisNo + "' and T0.\"U_SiparisSatirNo\" = '" + item.siparisSatirNo + "' and \"U_PaletNo\" = '" + item.PaletNo + "' and " + condition + "(\"U_KntynrNo\",'') ='' ");
                        ...
                        #endregion Tüm satırlarda sipariş numarası ve satır numarası olması gerektiğinden dolayı burası sipariş ve satır numarasına eşitleyerek çalışır.
                    ...
                    #endregion Palet ile eklenen ürünlerin toplanan tablosuna konteyner numarasını yazma işlemi
                }
                else
                {
                    ...
                    #endregion Öncelikle konteynerda olan dataların hepsi silinir daha sonra ekranda olanların hepsi yeniden yüklenir.
                    ...
                    if (cekmeListesiKalemleriniGrupla == "Y")
                    {
                        foreach (var item in konteynerIcindenSilinenlers.Where(x => x.paletNo != ""))
                        {
                            ...
                            {
                                SAPbobsCOM.Recordset orecord = (SAPbobsCOM.Recordset)oCompany.GetBusinessObject(BoObjectTypes.BoRecordset);
                                orecord.DoQuery("Select * from \"@AIF_WMS_TOPLANAN\" as T0 WITH (NOLOCK) where T0.\"U_BelgeNo\" = '" + item.cekmeNo + "' and T0.\"U_SiparisNumarasi\" = '" + satirKaynagiListesi[i].ToString().Split('-')[0].Trim() + "' and T0.\"U_SiparisSatirNo\" = '" + satirKaynagiListesi[i].ToString().Split('-')[1].Trim() + "' and \"U_PaletNo\" = '" + item.paletNo + "' and " + condition + "(\"U_KntynrNo\",'') <>'' and \"U_Miktar\" = '" + item.miktar + "' ");

                                string j = "Select * from \"@AIF_WMS_TOPLANAN\" as T0 WITH (NOLOCK) where T0.\"U_BelgeNo\" = '" + item.cekmeNo + "' and T0.\"U_SiparisNumarasi\" = '" + satirKaynagiListesi[i].ToString().Split('-')[0].Trim() + "' and T0.\"U_SiparisSatirNo\" = '" + satirKaynagiListesi[i].ToString().Split('-')[1].Trim() + "' and \"U_PaletNo\" = '" + item.paletNo + "' and " + condition + "(\"U_KntynrNo\",'') <>'' and \"U_Miktar\" = '" + item.miktar + "' ";
                    ...
                    else
                    {
                        foreach (var item in konteynerIcindenSilinenlers.Where(x => x.paletNo != ""))
                        {
                            ...
                            SAPbobsCOM.Recordset orecord = (SAPbobsCOM.Recordset)oCompany.GetBusinessObject(BoObjectTypes.BoRecordset);
                            orecord.DoQuery("Select * from \"@AIF_WMS_TOPLANAN\" as T0 WITH (NOLOCK) where T0.\"U_BelgeNo\" = '" + item.cekmeNo + "' and T0.\"U_SiparisNumarasi\" = '" + item.siparisNo + "' and T0.\"U_SiparisSatirNo\" = '" + item.siparisSatirNo + "' and \"U_PaletNo\" = '" + item.paletNo + "' and " + condition + "(\"U_KntynrNo\",'') <>'' and \"U_Miktar\" = '" + item.miktar + "' ");
                    ...
                    #endregion Palet ile konteynera girişi yapılmış olan satır için silme yapılır.
                    ...
                    if (cekmeListesiKalemleriniGrupla == "Y")
                    {
                        ...
                        foreach (var item in konteynerIcindenSilinenlers.Where(x => x.paletNo == ""))
                        {
                            ...
                            for (int i = 0; i <= satirKaynagiListesi.Count() - 1; i++)
                            {
                                ...
                                SAPbobsCOM.Recordset orecord = (SAPbobsCOM.Recordset)oCompany.GetBusinessObject(BoObjectTypes.BoRecordset);
                                orecord.DoQuery("Select * from \"@AIF_WMS_TOPLANAN\" as T0 WITH (NOLOCK) where T0.\"U_BelgeNo\" = '" + item.cekmeNo + "' and T0.\"U_SiparisNumarasi\" = '" + satirKaynagiListesi[i].ToString().Split('-')[0].Trim() + "' and T0.\"U_SiparisSatirNo\" = '" + satirKaynagiListesi[i].ToString().Split('-')[1].Trim() + "' and " + condition + " (T0.\"U_PaletNo\",'') = '' ");
                            ...
                            #endregion Toplanan tablosunda verileri güncelleme işlemi
                            ...
                            for (int i = 0; i <= satirKaynagiListesi.Count() - 1; i++)
                            {
                                ...
                                oRS_LineId.DoQuery("Select T1.\"LineId\",T0.\"DocEntry\" from \"@AIF_WMS_SIPKAR\" AS T0 WITH (NOLOCK) INNER JOIN \"@AIF_WMS_SIPKAR1\" AS T1 WITH (NOLOCK) ON T0.\"DocEntry\" = T1.\"DocEntry\" where T0.\"DocEntry\" = '" + item.cekmeNo + "' and T1.\"U_SipSatirNo\" = '" + satirKaynagiListesi[i].ToString().Split('-')[1].Trim() + "' and T1.\"U_SiparisNumarasi\" = '" + satirKaynagiListesi[i].ToString().Split('-')[0].Trim() + "'");
                            ...
                            #endregion Sipariş karşılama ekranında toplanan miktarları azaltma işlemi
                        }
                    }
                    else
                    {
                        ...
                        foreach (var item in konteynerIcindenSilinenlers.Where(x => x.paletNo == ""))
                        {
                            ...
                            SAPbobsCOM.Recordset orecord = (SAPbobsCOM.Recordset)oCompany.GetBusinessObject(BoObjectTypes.BoRecordset);
                            orecord.DoQuery("Select * from \"@AIF_WMS_TOPLANAN\" as T0 WITH (NOLOCK) where T0.\"U_BelgeNo\" = '" + item.cekmeNo + "' and T0.\"U_SiparisNumarasi\" = '" + item.siparisNo + "' and T0.\"U_SiparisSatirNo\" = '" + item.siparisSatirNo + "' and " + condition + " (T0.\"U_PaletNo\",'') = '' ");
                            ...
                            oRS_LineId.DoQuery("Select T1.\"LineId\",T0.\"DocEntry\" from \"@AIF_WMS_SIPKAR\" AS T0 WITH (NOLOCK) INNER JOIN \"@AIF_WMS_SIPKAR1\" AS T1 WITH (NOLOCK) ON T0.\"DocEntry\" = T1.\"DocEntry\" where T0.\"DocEntry\" = '" + item.cekmeNo + "' and T1.\"U_SipSatirNo\" = '" + item.siparisSatirNo + "' and T1.\"U_SiparisNumarasi\" = '" + item.siparisNo + "'");
                    ...
                    #endregion Konteyner içerisinden paletsiz ürün silme işlemi
                    ...
                    #endregion Ürün konteynere ilk defa atılıyorsa toplanan tablosuna ve sipariş karşılamaya verileri atılır.
                }
        ...
        private List<ToplanandanAzaltma> toplanandanAzaltmas = new List<ToplanandanAzaltma>();
