    ...
    public class GetCekmeListesiToplanan
    {
        public Response getCekmeListesiToplanan(string dbName, string baslangicTarihi, string bitisTarihi, string mKod)
        {
            ...
            try
            {
                ...
                if (connstring != "")
                {
                    ...
                    var query = "Select T0.\"DocEntry\",T0.\"U_MusteriKodu\",T0.\"U_MusteriAdi\",\"U_Aciklama\" from \"@AIF_WMS_SIPKAR\" as T0 WITH (NOLOCK) where T0.\"U_OnayDurumu\" = 'O' and (\"U_TerminalGizle\" <> 'Y' or \"U_TerminalGizle\" is null)";
        ...
        public Response getCekmeListesiDetaylari(string dbName, string docEntry, string mKod)
        {
            ...
            try
            {
                ...
                if (connstring != "")
                {
                    var query = "Select * from (Select T1.\"U_SiparisNumarasi\" as \"SiparisNumarasi\",T1.\"U_UrunKodu\" as \"UrunKodu\",T1.\"U_UrunTanimi\" as \"UrunTanimi\",T1.\"U_SipSatirNo\" as \"SipSatirNo\",T1.\"U_PlanSipMik\" - ISNULL((Select SUM(T99.\"U_Miktar\") from \"@AIF_WMS_TOPLANAN\" as T99 WITH (NOLOCK) where T99.\"U_SiparisNumarasi\" = T1.\"U_SiparisNumarasi\" and T99.\"U_SiparisSatirNo\" = T1.\"U_SipSatirNo\" and T99.\"U_BelgeNo\" = T0.\"DocEntry\"),0) as \"PlanlananSiparisMiktari\",(Select TOP 1 \"Substitute\" from OSCN as T97 WITH (NOLOCK) where T97.\"CardCode\" = T0.\"U_MusteriKodu\") as \"MuhatapKatalogNo\",(Select \"CodeBars\" from \"OITM\" as T96 WITH (NOLOCK) where T96.\"ItemCode\" = T1.\"U_UrunKodu\") as \"Barkod\",(Select \"ManBtchNum\" from \"OITM\" as T96 WITH (NOLOCK) where T96.\"ItemCode\" = T1.\"U_UrunKodu\") as \"Partili\",T1.\"LineId\" as \"SatirNo\",'' as \"PaletNo\",cast(0 as decimal(15,2)) as \"Miktar\" from \"@AIF_WMS_SIPKAR\" as T0 WITH (NOLOCK) INNER JOIN \"@AIF_WMS_SIPKAR1\" AS T1 WITH (NOLOCK) ON T0.\"DocEntry\" = T1.\"DocEntry\"  where T0.\"DocEntry\" = '" + docEntry + "') as tbl where tbl.\"PlanlananSiparisMiktari\" > 0 ";
