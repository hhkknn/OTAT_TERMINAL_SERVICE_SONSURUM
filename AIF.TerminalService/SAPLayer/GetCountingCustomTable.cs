    ...
    public class GetCountingCustomTable
    {
        ...
        public Response getCountingCustomTable(string dbName, string kullaniciId, string mKod)
        {
            ...
            try
            {
                ...
                if (connstring != "")
                {
                    var query = "Select \"DocEntry\" as \"Belge No\", CONVERT(varchar, \"U_SayimTarihi\",103) as \"Sayım Tarihi\",\"U_KullaniciId\" as \"Kullanıcı Id\",\"U_KullaniciAdi\" as \"Kullanıcı Adı\",\"U_Aciklama\" as \"Açıklama\" from \"@AIF_WMS_WHSCOUNT\" WITH (NOLOCK) where ISNULL(\"U_SayimNumarasi\",'') = '' and \"U_KullaniciId\" = '" + kullaniciId + "' ";
        ...
        public Response getLinesCountingCustomTableByDocEntry(string dbName, int DocEntry, string mKod)
        {
            ...
            try
            {
                ...
                if (connstring != "")
                {
                    ...
                    var query = "Select T1.\"U_Barkod\" as \"Barkod\",T1.\"U_KalemKodu\" as \"Ürün Kodu\", T1.\"U_KalemTanimi\" as \"Ürün Adı\", T1.\"U_DepoKodu\" as \"Depo Kodu\", T1.\"U_DepoAdi\" as \"Depo Adı\", T1.\"U_Miktar\" as \"Miktar\",T1.\"U_OlcuBirimi\" as \"Ölçü Birimi\",T1.\"U_DepoYeriId\" as \"DepoYeriId\",T1.\"U_DepoYeriAdi\" as \"DepoYeriAdi\",T0.\"U_Aciklama\" as \"Açıklama\" from \"@AIF_WMS_WHSCOUNT\" T0 WITH (NOLOCK) INNER JOIN \"@AIF_WMS_WHSCOUNT1\" T1 WITH (NOLOCK) ON T0.\"DocEntry\" = T1.\"DocEntry\" where T1.\"DocEntry\" = " + DocEntry + "";
        ...
        public Response getPartiesCountingCustomTableByDocEntry(string dbName, int DocEntry, string mKod)
        {
            ...
            try
            {
                ...
                if (connstring != "")
                {
                    var query = "Select \"U_KalemKodu\" as \"Ürün Kodu\", \"U_DepoKodu\" as \"Depo Kodu\",\"U_PartiNo\" as \"Parti No\",\"U_Miktar\" as \"Miktar\" from \"@AIF_WMS_WHSCOUNT2\" WITH (NOLOCK) where \"DocEntry\" = " + DocEntry + "";
        ...
        public Response getCountingCustomTableByDate(string dbName, string kullaniciId, string sayimTarihi, string mKod)
        {
            ...
            try
            {
                ...
                if (connstring != "")
                {
                    var query = "Select \"DocEntry\" as \"Belge No\", CONVERT(varchar, \"U_SayimTarihi\",103) as \"Sayım Tarihi\",\"U_KullaniciId\" as \"Kullanıcı Id\",\"U_KullaniciAdi\" as \"Kullanıcı Adı\",\"U_Aciklama\" as \"Açıklama\" from \"@AIF_WMS_WHSCOUNT\" WITH (NOLOCK) where ISNULL(\"U_SayimNumarasi\",'') = '' and \"U_KullaniciId\" = '" + kullaniciId + "' and \"U_SayimTarihi\" = '" + sayimTarihi + "' ";
