    ...
    public class AddOrUpdateStockCounting
    {
        ...
        public Response addOrUpdateStockCounting(string dbName, StockCounting stockCounting)
        {
            ...
            try
            {
                ...
                {
                    oRS.DoQuery("Select * from \"@AIF_WMS_WHSCOUNT\" WITH (NOLOCK) where \"U_SayimTarihi\" = '" + formatdt + "' and \"U_KullaniciId\"= '" + stockCounting.KullaniciId + "' and " + condition + "(\"U_SayimNumarasi\",0)=0");
                ...
                #endregion recordcount ile işlemler
                ...
                else
                {
                    ...
                    oRS.DoQuery("Select * FROM OHEM WITH (NOLOCK) WHERE \"empID\"= '" + stockCounting.KullaniciId + "'");
