    ...
    public class AddOrUpdateCekmeListesiOnay
    {
        ...
        public Response addOrUpdateCekmeListesiOnay(string dbName, CekmeListesiOnaylama cekmeListesiOnaylama, List<SilinenPaletNoListesi> silinenPaletNoListesis, string cekmeListesiKalemleriniGrupla)
        {
            ...
            try
            {
                ...
                string musteriKodu = "";
                oRS.DoQuery("Select \"DocEntry\",\"U_MuhKatGoster\",\"U_MusteriKodu\" from \"@AIF_WMS_SIPKAR\" as T0 WITH (NOLOCK) where T0.\"DocEntry\" = '" + cekmeListesiOnaylama.BelgeNo + "'");
                ...
                else
                {
                    ...
                    #endregion Sipariş karşılama işlemleri
                    ...
                    try
                    {
                        ...
                        #endregion Palet Tablosunu İşlemleri
                        ...
                        try
                        {
                            ...
                            {
                                oRS.DoQuery("Select \"DocEntry\" from \"@AIF_WMS_KOLIDTY\" as T0 WITH (NOLOCK) where T0.\"U_BelgeNo\" = '" + cekmeListesiOnaylama.BelgeNo + "'");
                                islemvar = false;
                                guncelleme = false;
                                ...
                                if (oRS.RecordCount > 0)
                                {
                                    ...
                                    foreach (var itemy in cekmeListesiOnaylama.cekmeListesiOnaylamaKoliDetays)
                                    {
                                        ...
                                        #endregion satır silme palet no yazırılıp listeleme yapılması ııcın kaldırıldı
                        ...
                        #endregion Koli Tablosunu Güncelleme
                        ...
                        try
                        {
                            if (oCompany.InTransaction)
                            {
                                ...
                                {
                                    string sss = "Select \"DocEntry\" from \"@AIF_WMS_PALET\" as T0 WITH (NOLOCK) where T0.\"U_PaletNo\" = '" + item.paletNo + "' ";
                                    oRS.DoQuery(sss);
                                    ...
                                    sss = "SELECT \"U_KalemKodu\" from \"@AIF_WMS_PALET1\" WITH (NOLOCK) where \"DocEntry\" = '" + doc + "' and \"U_SiparisNo\" = '" + item.siparisNo + "' and \"U_SipSatirNo\" = '" + item.siparisSatirNo + "'  ";
                                ...
                                #endregion SilinenPaletNumaralari
                            }
                        }
                        catch (Exception)
                        {
